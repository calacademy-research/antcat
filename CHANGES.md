...
* [Task completed] Removed HOL database tables; data was migrated to `Taxon` in 529c73b2f8b03173647b5c5325a31890e1a2dfc5. We can use any 2016 db dump from before November 8 if we need to recreate. Related issues: #98, #108. TODO add hash.
