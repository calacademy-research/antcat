...
describe ReferencesController do
  ...
  it "should use the right exporter" do
    fisher_reference = FactoryGirl.create :article_reference, :author_names => [FactoryGirl.create(:author_name, :name => 'Fisher, B.L.')]
    ...
    bolton_reference = FactoryGirl.create :article_reference, :author_names => [FactoryGirl.create(:author_name, :name => 'Bolton, B.L.')]
