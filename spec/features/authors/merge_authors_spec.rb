...
feature "Merging authors", as: :editor do
  ...
  scenario "Merging two authors" do
    ...
    i_follow "Merge"
    author_to_merge = AuthorName.find_by!(name: "Bolton, Ba.").author
    find('#author_to_merge_id', visible: false).set(author_to_merge.id) # HACK: For when JavaScript is disabled.
    click_button "Next"
    ...
    i_should_be_on author_path(author)
