...
describe ReferenceHelper do
  describe "formattng reference" do
    it "should format the reference" do
      reference = Factory(:ward_reference, :authors => "Forel, A.", :year => "1874", :title => "Les fourmis de la Suisse",
    ...
    it "should add a period after the title if none exists" do
      reference = Factory(:ward_reference, :authors => "authors", :year => "year", :title => "No period", :citation => "citation")
    ...
    it "should not add a period after the title if there's already one" do
      reference = Factory(:ward_reference, :authors => "authors", :year => "year", :title => "With period.", :citation => "citation")
    ...
    it "should add a period after the citation if none exists" do
      reference = Factory(:ward_reference, :authors => "authors", :year => "year", :title => "title", :citation => "No period")
    ...
    it "should not add a period after the citation if there's already one" do
      reference = Factory(:ward_reference, :authors => "authors", :year => "year", :title => "title", :citation => "With period.")
  ...
  describe "formatting the date" do
    ...
    def make date
      @reference = Factory(:ward_reference, :date => date, :authors => "authors", :year => "year", :title => "title", :citation => "With period.")
    end
