...
describe LinkHelper do
  ...
  describe "Creating a link from a site to AntWeb" do
    it "should handle subfamilies" do
      ...
      expect(helper.link_to_antweb(subfamily)).to eq("<a class=\"link_to_external_site\" href=\"http://www.antweb.org/description.do?rank=subfamily&subfamily=attaichnae&project=worldants\" target=\"_blank\">AntWeb</a>")
    end
    ...
    it "should handle genera" do
      ...
      expect(helper.link_to_antweb(genus)).to eq("<a class=\"link_to_external_site\" href=\"http://www.antweb.org/description.do?rank=genus&genus=atta&project=worldants\" target=\"_blank\">AntWeb</a>")
    end
    ...
    it "should handle species" do
      ...
      expect(helper.link_to_antweb(species)).to eq("<a class=\"link_to_external_site\" href=\"http://www.antweb.org/description.do?rank=species&genus=atta&species=major&project=worldants\" target=\"_blank\">AntWeb</a>")
    end
    it "should handle subspecies" do
      genus = create_genus 'Atta'
      species = create_species 'Atta major', genus: genus
      subspecies = create_subspecies 'Atta major minor', species: species, genus: genus
      expect(helper.link_to_antweb(subspecies)).to eq("<a class=\"link_to_external_site\" href=\"http://www.antweb.org/description.do?rank=subspecies&genus=atta&species=major&subspecies=minor&project=worldants\" target=\"_blank\">AntWeb</a>")
    end
    ...
    it "should handle quadrinomial subspecies" do
      ...
      expect(helper.link_to_antweb(subspecies)).to eq("<a class=\"link_to_external_site\" href=\"http://www.antweb.org/description.do?rank=subspecies&genus=atta&species=major&subspecies=minor rufous&project=worldants\" target=\"_blank\">AntWeb</a>")
    end
  end
end
