  ...
  describe "exporting" do
    ...
    describe "Outputting taxa" do
      before do
        ...
        @tribe = FactoryGirl.create :tribe, :name => 'Attini', :subfamily => @subfamily
        @genus = FactoryGirl.create :genus, :name => 'Atta', :subfamily => @subfamily, :tribe => @tribe
        @species = FactoryGirl.create :species, :name => 'robusta', :subfamily => @subfamily, :genus => @genus
      end
      ...
      describe "Outputting subspecies" do
        before do
          @subspecies = FactoryGirl.create :subspecies, :name => 'rufa', :genus => @genus, :species => @species
        end
    ...
    describe "Outputting a number of taxa" do
      it "should sort its output by names in ranks" do
        ...
        cephalotini = FactoryGirl.create :tribe, :name => 'Cephalotini', :subfamily => myrmicinae

        atta = FactoryGirl.create :genus, :name => 'Atta', :tribe => attini, :subfamily => myrmicinae
        cephalotes = FactoryGirl.create :genus, :name => 'Cephalotes', :tribe => cephalotini, :subfamily => myrmicinae

        robusta = FactoryGirl.create :species, :name => 'robusta', :genus => atta
        adolphi = FactoryGirl.create :species, :name => 'adolphi', :genus => cephalotes

        rufa = FactoryGirl.create :subspecies, :name => 'rufa', :species => adolphi
    ...
    describe "Outputting the senior synonym of a species" do
      before do
        ...
        @senior_synonym = FactoryGirl.create :species, :name => 'formica', :genus => @atta
        @junior_synonym = FactoryGirl.create :species, :name => 'robusta', :genus => @atta, :status => 'synonym', :synonym_of => @senior_synonym
      end
