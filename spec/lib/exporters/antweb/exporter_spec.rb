...
describe Exporters::Antweb::Exporter do
  ...
  describe "Sending 'author_date_html' that includes the full reference in the rollover" do
    it "should do it" do
      ...
      expect(string).to eq('<span title="Forel, A. 1874. Les fourmis de la Suisse. Neue Denkschriften 26:1-452 DOI:<a class="document_link" href="http://dx.doi.org/10.10.1038/nphys1170" target="_blank">10.10.1038/nphys1170</a>.">Forel, 1874</span>')
    end
  end
