  ...
  describe "exporting one taxon" do
    ...
    describe "Exporting species" do
      ...
      it "should export one correctly" do
        ...
        atta = FactoryGirl.create :genus, name_factory('Atta', :tribe => attini)
        species = FactoryGirl.create :species, name_factory('robustus', :genus => atta, :taxonomic_history => 'history')
      ...
      it "should export a species without a tribe" do
        myrmicinae = FactoryGirl.create :subfamily, name_factory('Myrmicinae')
        atta = FactoryGirl.create :genus, name_factory('Atta', :subfamily => myrmicinae, :tribe => nil)
        species = FactoryGirl.create :species, name_factory('robustus', :genus => atta, :taxonomic_history => 'history')
        Exporters::Antweb::Formatter.should_receive(:format_taxonomic_history_with_statistics_for_antweb).with(species, :include_invalid => false).and_return 'history'
      ...
      it "should export a species without a subfamily as being in the 'incertae sedis' subfamily" do
        atta = FactoryGirl.create :genus, name_factory('Atta', :subfamily => nil, :tribe => nil)
        species = FactoryGirl.create :species, name_factory('robustus', :genus => atta, :taxonomic_history => 'history')
        Exporters::Antweb::Formatter.should_receive(:format_taxonomic_history_with_statistics_for_antweb).with(species, :include_invalid => false).and_return 'history'
    ...
    describe "Exporting subspecies" do
      ...
      it "should export one correctly" do
        ...
        attini = FactoryGirl.create :tribe, name_factory('Attini', :subfamily => myrmicinae)
        atta = FactoryGirl.create :genus, name_factory('Atta', :tribe => attini)
        species = FactoryGirl.create :species, name_factory('robustus', :genus => atta)
        subspecies = FactoryGirl.create :subspecies, name_factory('emeryii', :species => species, :taxonomic_history => 'history')
