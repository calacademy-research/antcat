...
"<p class=\"taxon_statistics\">Fossil: 2 valid subfamilies</p>"
    ...
    it "should not pluralize certain statuses" do
      @formatter.statistics(:extant => {:species => {'valid' => 2, 'synonym' => 2, 'homonym' => 2, 'unavailable' => 2, 'excluded from Formicidae' => 2}}).should == "<p class=\"taxon_statistics\">2 valid species (2 synonyms, 2 homonyms, 2 unavailable, 2 excluded from Formicidae)</p>"
    end
