...
describe Antweb::Exporter do
  ...
  describe "exporting one taxon" do
    ...
    it "should export a subfamily" do
      ...
      Factory :genus, :subfamily => ponerinae
      Factory :genus, :subfamily => ponerinae, :fossil => true
      @exporter.export_taxon(ponerinae).should == ['Ponerinae', nil, nil, nil, nil, nil, 'TRUE', nil, nil, nil, '<p class="taxon_statistics">1 genus</p><p>Ponerinae</p>']
    end
    ...
    it "should export a genus" do
      ...
      CatalogFormatter.should_receive(:format_taxonomic_history_with_statistics).with(acanthognathus, :include_fossil => false, :include_invalid => false).and_return 'history'
    ...
    it "should not export invalid taxa" do
      ...
      CatalogFormatter.should_receive(:format_taxonomic_history_with_statistics).with(valid_genus, :include_fossil => false, :include_invalid => false).and_return 'history'
      CatalogFormatter.should_not_receive(:format_taxonomic_history_with_statistics).with(invalid_genus, :include_fossil => false, :include_invalid => false)
    ...
    describe "Exporting species" do
      ...
      it "should export one correctly" do
        ...
        CatalogFormatter.should_receive(:format_taxonomic_history_with_statistics).with(species, :include_fossil => false, :include_invalid => false).and_return 'history'
    ...
    describe "Exporting subspecies" do
      ...
      it "should export one correctly" do
        ...
        CatalogFormatter.should_receive(:format_taxonomic_history_with_statistics).with(subspecies, :include_fossil => false, :include_invalid => false).and_return 'history'
