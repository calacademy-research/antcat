...
describe Antweb::Exporter do
  ...
  describe "exporting one taxon" do
    it "should export a subfamily" do
      ...
      @exporter.export_taxon(ponerinae).should == ['Ponerinae', nil, nil, nil, nil, nil, 'TRUE', 'TRUE', nil, nil, '<p class="taxon_statistics">1 genus</p><p>Ponerinae</p>', 'FALSE']
    end
    ...
    it "should export fossil taxa" do
      ...
      @exporter.export_taxon(ponerinae).should == ['Ponerinae', nil, nil, nil, nil, nil, 'TRUE', 'TRUE', nil, nil, '<p class="taxon_statistics">Extant: 1 genus</p><p class="taxon_statistics">Fossil: 1 genus</p><p>Ponerinae</p>', 'FALSE']
    ...
    it "should export a genus" do
      ...
      @exporter.export_taxon(acanthognathus).should == ['Myrmicinae', 'Dacetini', 'Acanothognathus', nil, nil, nil, 'TRUE', 'TRUE', nil, nil, 'history', 'FALSE']
    end
    ...
    it "should export a genus without a tribe" do
      ...
      CatalogFormatter.should_receive(:format_taxonomic_history_with_statistics).with(acanthognathus, :include_invalid => false).and_return 'history'
      @exporter.export_taxon(acanthognathus).should == ['Myrmicinae', nil, 'Acanothognathus', nil, nil, nil, 'TRUE', 'TRUE', nil, nil, 'history', 'FALSE']
    end
    ...
    it "should export a genus without a subfamily as being in 'incertae_sedis'" do
      ...
      CatalogFormatter.should_receive(:format_taxonomic_history_with_statistics).with(acanthognathus, :include_invalid => false).and_return 'history'
      @exporter.export_taxon(acanthognathus).should == ['incertae_sedis', nil, 'Acanothognathus', nil, nil, nil, 'TRUE', 'TRUE', nil, nil, 'history', 'FALSE']
    end
    ...
    it "should not export invalid taxa" do
      ...
      @exporter.export_taxon(valid_genus).should == [subfamily.name, tribe.name, valid_genus.name, nil, nil, nil, 'TRUE', 'TRUE', nil, nil, 'history', 'FALSE']
      @exporter.export_taxon(unidentifiable_genus).should == [subfamily.name, tribe.name, unidentifiable_genus.name, nil, nil, nil, 'FALSE', 'FALSE', nil, nil, 'history', 'FALSE']
    ...
    describe "Exporting species" do
      ...
      it "should export one correctly" do
        ...
        @exporter.export_taxon(species).should == ['Myrmicinae', 'Attini', 'Atta', 'robustus', nil, nil, 'TRUE', 'TRUE', nil, nil, 'history', 'FALSE']
      end
    ...
    describe "Exporting subspecies" do
      ...
      it "should export one correctly" do
        ...
        @exporter.export_taxon(subspecies).should == ['Myrmicinae', 'Attini', 'Atta', 'robustus emeryii', nil, nil, 'TRUE', 'TRUE', nil, nil, 'history', 'FALSE']
      end
