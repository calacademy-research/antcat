  ...
  describe "Importing HTML" do
    ...
    normal'><span lang=EN-GB>FAMILY FORMICIDAE<o:p></o:p></span></b></p>
      ...
      it "should parse each part of the family section" do
        @subfamily_catalog.should_receive(:parse_family_summary).ordered
        @subfamily_catalog.should_receive(:parse_genera_incertae_sedis_in_family).ordered
        @subfamily_catalog.should_receive(:parse_genera_excluded_from_family).ordered
        @subfamily_catalog.should_receive(:parse_unavailable_group_names).ordered
        @subfamily_catalog.should_receive(:parse_genus_group_nomina_nuda).ordered
        @subfamily_catalog.import_html make_contents %{
    <p class=MsoNormal align=center style='text-align:center'><b style='mso-bidi-font-weight:
    normal'><span lang=EN-GB>FAMILY FORMICIDAE<o:p></o:p></span></b></p>
        }
