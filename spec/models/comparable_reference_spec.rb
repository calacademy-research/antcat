...
describe ComparableReference do
  ...
  context "type mismatch" do
    ...
    let(:rhs) do
      described_class.new type: 'NestedReference',
        principal_author_last_name_cache: 'Fisher, B. L.', title: 'Ants', year: '1975'
    end
  ...
  describe "author + year matching" do
    context "when the author names don't match but the years do" do
      let(:lhs) { described_class.new year: 2010 }
      let(:rhs) { described_class.new year: 2010 }
    ...
    context 'when the author names match' do
      let(:lhs) { described_class.new title: 'A', principal_author_last_name_cache: 'Fisher, B. L.' }
      let(:rhs) { described_class.new title: 'B', principal_author_last_name_cache: 'Fisher, B. L.' }
  ...
  describe "title + year matching" do
    let(:lhs) { described_class.new principal_author_last_name_cache: 'Fisher, B. L.' }
    let(:rhs) { described_class.new principal_author_last_name_cache: 'Fisher, B. L.' }
