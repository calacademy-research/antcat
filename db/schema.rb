...
ActiveRecord::Schema.define(:version => 20121029232853) do
  ...
  add_index "antwiki_valid_taxa", ["name"], :name => "antwiki_valid_taxa_name_index", :unique => true
  add_index "antwiki_valid_taxa", ["name"], :name => "antwiki_valid_taxa_name_index2", :unique => true
