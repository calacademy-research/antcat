# coding: UTF-8
module Catalog::AntwebFormatter

  def format_taxonomic_history_for_antweb taxon
    string = taxon.taxonomic_history
    string << format_homonym_replaced_for_antweb(taxon)
    string.html_safe if string
  end

  def format_homonym_replaced_for_antweb taxon
  ...
  def format_taxonomic_history_with_statistics_for_antweb taxon, options = {}
