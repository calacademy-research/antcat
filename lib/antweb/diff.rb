...
class Antweb::Diff
  ...
  def preprocess_antweb antweb
    ...
    for line in antweb
      ...
      if antweb_fields[1].blank? && antweb_fields[2].present?
        genus = Genus.find_by_name antweb_fields[2]
        tribe = genus && genus.tribe && genus.tribe.name
        antweb_fields[1] = tribe
      end

      # clear fields that aren't used and are often bogus anyway
      antweb_fields[4] = antweb_fields[5] = antweb_fields[9] = antweb_fields[8] = nil
