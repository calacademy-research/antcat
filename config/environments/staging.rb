...
# To compare with `production.rb`:
# git diff HEAD:config/environments/production.rb config/environments/staging.rb
...
Rails.application.configure do
  ...
  # key such as config/credentials/staging.key. This key is used to decrypt credentials (and other encrypted files).
