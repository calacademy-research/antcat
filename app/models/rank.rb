...
class Rank
  ...
  FAMILY_AND_GENUS_GROUP_NAMES = FAMILY_GROUP_NAMES + GENUS_GROUP_NAMES

  CAN_HAVE_TYPE_TAXON_TYPES = FAMILY_AND_GENUS_GROUP_NAMES
  CAN_BE_A_COMBINATION_TYPES = [GENUS, SUBGENUS, SPECIES, SUBSPECIES, INFRASUBSPECIES]
  ITALIC_TYPES = GENUS_GROUP_NAMES + SPECIES_GROUP_NAMES

  UNINOMIAL = FAMILY_AND_GENUS_GROUP_NAMES
  BINOMIAL = [SPECIES]
  ...
  class << self
    ...
    def number_of_countable_name_parts type
      case type
