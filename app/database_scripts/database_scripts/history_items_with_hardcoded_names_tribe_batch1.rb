...
module DatabaseScripts
  class HistoryItemsWithHardcodedNamesTribeBatch1 < DatabaseScript
    NAMES = Tribe.order(:name_cache).pluck(:name_cache)
...
title: History items with hardcoded names (tribe batch 1)
