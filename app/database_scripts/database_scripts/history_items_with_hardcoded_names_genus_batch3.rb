...
module DatabaseScripts
  class HistoryItemsWithHardcodedNamesGenusBatch3 < DatabaseScript
    NAMES = Genus.order(:name_cache).limit(500).offset(300 * 2).pluck(:name_cache)
...
title: History items with hardcoded names (genus batch 3)
