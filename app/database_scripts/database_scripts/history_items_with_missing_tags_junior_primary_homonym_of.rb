...
module DatabaseScripts
  class HistoryItemsWithMissingTagsJuniorPrimaryHomonymOf < DatabaseScript
    LIMIT = 250

    def results
      TaxonHistoryItem.where('taxt REGEXP ?', "^\\[Junior primary homonym of #{Taxt::MISSING_TAG_START}2").limit(LIMIT)
    end
...
title: History items with <code>missing</code> tags (junior primary homonym of)
