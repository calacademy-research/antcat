...
module DatabaseScripts
  class HistoryItemsWithMissingTagsUnresolvedJuniorPrimaryHomonymOf < DatabaseScript
    LIMIT = 250
    ...
    def results
      TaxonHistoryItem.where('taxt REGEXP ?', "^\\[Unresolved junior primary homonym of #{Taxt::MISSING_TAG_START}2").limit(LIMIT)
    end
...
title: History items with <code>missing</code> tags (unresolved junior primary homonym of)
