...
module DatabaseScripts
  class HistoryItemsWithMissingTagsUnresolvedJuniorSecondaryHomonymOf < DatabaseScript
    LIMIT = 250
    ...
    def results
      TaxonHistoryItem.where('taxt REGEXP ?', "^\\[Unresolved junior secondary homonym of #{Taxt::MISSING_TAG_START}2").limit(LIMIT)
    end
...
title: History items with <code>missing</code> tags (unresolved junior secondary homonym of)
...
related_scripts:
  - HistoryItemsWithMissingTagsUnresolvedJuniorPrimaryHomonymOf
  - HistoryItemsWithMissingTagsUnresolvedJuniorSecondaryHomonymOf
