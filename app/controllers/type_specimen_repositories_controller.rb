class TypeSpecimenRepositoriesController < ApplicationController
  def autocompletion_data
    respond_to do |format|
      format.json { render json: autocompletion_json }
    end
  end

  private
    # TODO this implementation is horrible, but the alternative is having
    # nothing at all. See https://github.com/calacademy-research/antcat/issues/183
    def autocompletion_json
      [
        ...
        "CEPEC - (AKA: CPDC) Laboratório de Mirmecologia Itabuna, Bahia, Brazil",
        ...
        "MTD - (AKA - MTKD) Museum für Tierkunde. Staatliche Naturhistorische Sammlungen Dresden. Dresden, Germany",
